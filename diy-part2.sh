...
sed -i '$a /overlay/upper/www/luci-static/resources/fileassistant' package/base-files/files/etc/sysupgrade.conf
sed -i '$a /www/luci-static/resources/fileassistant' package/base-files/files/etc/sysupgrade.conf
